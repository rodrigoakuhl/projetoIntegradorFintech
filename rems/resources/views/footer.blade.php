              ...
              <div class="py-6 px-5">
                ...
                <div class="row">
                  <div class="col-6">
                    ...
                    <div class="list-group list-group-borderless list-group-flush">
                      <a class="active d-flex align-items-center list-group-item list-group-item-action" href="#">
                        <img class="max-width-3 mr-2" src="{{URL::asset('vendor/flag-icon-css/flags/4x3/us.svg')}}" alt="United States Flag">
                        English
                      </a>
                      <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                        <img class="max-width-3 mr-2" src="{{URL::asset('vendor/flag-icon-css/flags/4x3/fr.svg')}}" alt="France Flag">
                        Français
                      </a>
                      <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                        <img class="max-width-3 mr-2" src="{{URL::asset('vendor/flag-icon-css/flags/4x3/de.svg')}}" alt="Germany Flag">
                        Deutsch
                      </a>
                      <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                        <img class="max-width-3 mr-2" src="{{URL::asset('vendor/flag-icon-css/flags/4x3/pt.svg')}}" alt="Portugal Flag">
                        Português
                      </a>
                    </div>
                  ...
                  <div class="col-6">
                    ...
                    <div class="list-group list-group-borderless list-group-flush">
                      <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                        <img class="max-width-3 mr-2" src="{{URL::asset('vendor/flag-icon-css/flags/4x3/es.svg')}}" alt="Spain Flag">
                        Español
                      </a>
                      <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                        <img class="max-width-3 mr-2" src="{{URL::asset('vendor/flag-icon-css/flags/4x3/it.svg')}}" alt="Italy Flag">
                        Italiano
                      </a>
                      <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                        <img class="max-width-3 mr-2" src="{{URL::asset('vendor/flag-icon-css/flags/4x3/ru.svg')}}" alt="Russian Flag">
                        Русский
                      </a>
                      <a class="d-flex align-items-center list-group-item list-group-item-action" href="#">
                        <img class="max-width-3 mr-2" src="{{URL::asset('vendor/flag-icon-css/flags/4x3/tr.svg')}}" alt="Turkey Flag">
                        Türkçe
                      </a>
                    </div>
                    <!-- End List of Languages -->
