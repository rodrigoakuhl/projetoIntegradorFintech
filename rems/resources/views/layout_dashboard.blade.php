...
<!--                     <div class="help-box text-white text-center">
                        ...
                        <img src="{{URL::asset('dash/assets/images/help-icon.svg')}}" height="90" alt="Helper Icon Image" />
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                                    ...
                                    <div class="slimscroll" style="max-height: 230px;">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="{{URL::asset('dash/assets/images/users/avatar-2.jpg')}}" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="{{URL::asset('dash/assets/images/users/avatar-4.jpg')}}" class="img-fluid rounded-circle" alt="" /> </div>
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown ">
                                    ...
                                    <!-- item-->
                                    <a href="/dashboard/cadastro" class="dropdown-item notify-item">
