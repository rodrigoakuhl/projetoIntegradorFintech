...
<body>
          ...
          <div class="js-scrollbar u-sidebar__body">
            <div class="u-sidebar__content py-5">
              ...
              <ul class="list-unstyled font-size-14 mb-5">
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="{{URL::asset('svg/components/finance-dark-icon.svg')}}" alt="Image Description">
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="{{URL::asset('svg/components/touch-dark-icon.svg')}}" alt="Image Description">
                    <div class="media-body">
                      <span>Activity</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="{{URL::asset('svg/components/team-dark-icon.svg')}}" alt="Image Description">
                    <div class="media-body">
                      <span>Team</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="{{URL::asset('svg/components/email-dark-icon.svg')}}" alt="Image Description">
                    <div class="media-body">
                      <span>Mailbox</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="{{URL::asset('svg/components/projects-dark-icon.svg')}}" alt="Image Description">
                    <div class="media-body">
                      <span>Projects</span>
                    </div>
                  </a>
              ...
              <ul class="list-unstyled font-size-14 mb-0">
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="{{URL::asset('svg/components/calendar-dark-icon.svg')}}" alt="Image Description">
                    <div class="media-body">
                      <span>Calendar</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="{{URL::asset('svg/components/cog-dark-icon.svg')}}" alt="Image Description">
                    <div class="media-body">
                      <span>Tools</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="{{URL::asset('svg/components/archive-dark-icon.svg')}}" alt="Image Description">
                    <div class="media-body">
                      <span>Archive</span>
                    </div>
                  </a>
  ...
  <div id="signupModal" class="js-signup-modal u-modal-window" style="width: 500px;">
    ...
    <div class="p-5">
      ...
      <form action="signup.blade.php" method="post" class="js-novalidate">
        <!-- Signup -->
      ...
      <form action="forgot.blade.php" method="post" class="js-novalidate"></form>
        <!-- Forgot Password -->
