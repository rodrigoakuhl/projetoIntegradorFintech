...
<!--             <a class="btn btn-sm btn-primary btn-wide" href="https://themes.getbootstrap.com/product/space-multipurpose-responsive-template/">
 ...
 -->          </div>
        ...
        <div class="col-md-6 order-md-1" style="margin-bottom: -25%;">
          <object type="image/png" style="height: 50%" data="{{URL::asset('img/imagemlayout1.png')}}"></object>
        </div>
      </div>
    </div>
    ...
    <!--<div class="container space-2 space-3--lg">
      <div class="row justify-content-lg-between">
        ...
        <div class="col-md-6">
          <object type="image/svg+xml" data="{{URL::asset('svg/mockups/tablet-mockup-2.svg')}}"></object>
        </div>
      </div>
    </div>-->
    <!-- End Features Section -->
